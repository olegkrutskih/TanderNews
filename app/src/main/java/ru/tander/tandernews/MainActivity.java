...
import ru.tander.tandernews.adapters.NewsAdapter;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ArrayList<String[]> newsData = getDataSet();
        ...
        NewsAdapter.OnItemClickListener onItemClickListener = new NewsAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View v, int position) {
                ...
                //intent.putExtra(NewsActivity.EXTRA_PARAM_ID, position);
    ...
    private void getDataSet() {
        ...
        App.getApi().getData().enqueue(new Callback<List<NewsModel>>() {
            @Override
            public void onResponse(Call<List<NewsModel>> call, Response<List<NewsModel>> response) {
                NewsModel answer = response.body().get(0);
                mNewses.clear();
                mNewses.addAll(answer.getResult());
